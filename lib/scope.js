...
export async function purgeData() {
  ...
  await fs.rm("/home/pi/data/export", { force: true, recursive: true })
  await fs.rm("/home/pi/data/img", { force: true, recursive: true })
  await fs.rm("/home/pi/data/objects", { force: true, recursive: true })
}
