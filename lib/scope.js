...
export async function turnBullerOn() {
  await publish("actuator/buller", { action: "on" })
}

export async function turnBullerOff() {
  await publish("actuator/buller", { action: "off" })
}
