...
export async function setHardwareVersion(hardware_version) {
  ...
  if (hardware_version == "v2.6") {
    await Promise.all([
      ...
      enableServices(["planktoscope-org.controller.light"]),
      stopService("planktoscope-org.controller.bubbler"),
      stopService("planktoscope-org.controller.display"),
    ])
    ...
    await Promise.all([
      ...
      restartService("planktoscope-org.controller.bubbler"),
      restartService("planktoscope-org.controller.display"),
    ])
  }

  await Promise.all([
    restartService("planktoscope-org.controller"),
    restartService("planktoscope-org.controller.light"),
  ])
