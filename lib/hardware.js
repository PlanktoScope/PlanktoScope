...
import { stopService, startService } from "./systemctl.js"
...
export async function setHardwareVersion(hardware_version) {
  ...
  console.log("Stopping nodered")
  await stopService("nodered")
  console.log("Stopped nodered")
  console.log("Stopping planktoscope-org.controller")
  await stopService("planktoscope-org.controller")
  console.log("Stopped planktoscope-org.controller")
  console.log("Starting nodered")
  await startService("nodered")
  console.log("Started nodered")
  console.log("Starting planktoscope-org.controller")
  await startService("planktoscope-org.controller")
  console.log("Started planktoscope-org.controller")
}
