...
cp /usr/lib/firmware/raspberrypi/bootloader-2712/latest/pieeprom-2025-10-17.bin /tmp
cp /usr/lib/firmware/raspberrypi/bootloader-2712/latest/recovery.bin /tmp

rpi-eeprom-config /tmp/pieeprom-2025-10-17.bin --config boot.ini --out /tmp/pieeprom.upd
