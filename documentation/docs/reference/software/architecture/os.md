...
- The [PlanktoScope segmenter](https://github.com/PlanktoScope/PlanktoScope/tree/main/segmenter): for processing raw image datasets acquired by the PlanktoScope hardware controller to detect and extract particles from raw images.
