...
4. It includes the cost of labor provided by FairScope to develop open-source design improvements to the PlanktoScope's hardware which were made for the PlanktoScope's v2.5 and v2.6 hardware designs.
