...
- (Likely user-facing change; System) The default timezone has been changed to UTC, and we will be using UTC as the standard system time zone for all PlanktoScopes. However, we may provide GUI functionality for displaying times in a local time zone.
